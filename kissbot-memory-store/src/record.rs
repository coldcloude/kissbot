...
pub struct RecordManager {
    channel_context: RecordContext<ChannelRequestEntity, ChannelRecordKey, ChannelRecord, ChannelParser>,
...
impl RecordManager {
    ...
    pub async fn append_channel_record(&self, requests: Vec<ChannelRequestEntity>, force: bool) -> Result<()> {
